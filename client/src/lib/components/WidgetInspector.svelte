  ...
  const gaugeTypes: { value: GaugeType; label: string; description: string }[] =
    [
      ...
      },
      {
        value: "linear",
        label: "Linear Bar",
        description: "Horizontal or vertical bar",
      },
      {
        value: "graph",
        label: "Time Graph",
        description: "Historical data chart",
      },
      {
        value: "image",
        label: "Image Sequence",
        description: "Custom image animation",
      },
      {
        value: "glassmorphic",
        label: "Glassmorphic",
...
<div class="p-4 space-y-6">
  ...
  {:else}
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-xs text-[var(--theme-text-muted)] mt-1">
          {gaugeTypes.find((g) => g.value === selectedWidget.gauge_type)
            ?.description}
        </p>
      </div>
    </div>
      ...
      {#if selectedWidget.show_unit}
        <div>
          ...
          <input
            ...
            oninput={(e) =>
              updateWidget({ custom_unit: e.currentTarget.value || undefined })}
          />
        </div>
      {/if}
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center justify-between">
        <label for="wi-lock-widget" class="text-sm text-[var(--theme-text)]"
          >Lock Widget</label
        >
        <input
          id="wi-lock-widget"
    ...
    {#if selectedWidget.gauge_type === "radial"}
      <div class="space-y-4">
        ...
        <div>
          <label
            for="wi-start-angle"
            class="block text-sm text-[var(--theme-text)] mb-1"
            >Start Angle (degrees)</label
          >
          <input
            id="wi-start-angle"
            type="number"
        ...
        <div>
          ...
          <input
            ...
            oninput={(e) =>
              updateGaugeSettings(
                "end_angle",
                parseInt(e.currentTarget.value) || 270,
              )}
          />
        </div>
      </div>
    {:else if selectedWidget.gauge_type === "linear"}
      <div class="space-y-4">
        ...
        <div>
          <label
            for="wi-orientation"
            class="block text-sm text-[var(--theme-text)] mb-2"
            >Orientation</label
          >
          <select
            id="wi-orientation"
            ...
            onchange={(e) =>
              updateGaugeSettings(
                "orientation",
                e.currentTarget.value as "horizontal" | "vertical",
              )}
          >
