...
import type { WidgetConfig, SensorData, SensorSourceFromAPI, StyleSettings } from './types';
...
/** Demo sensor sources in SensorSourceFromAPI format (sensors keyed by ID, matching the real API shape) */
export const demoSensorSources: Record<string, SensorSourceFromAPI> = {
  mock: {
    id: 'mock',
...
export const demoSensorData: Record<string, SensorData> = { ...mockSensors };

const noStyle: StyleSettings = {};
...
export const demoWidgets: WidgetConfig[] = [
  {
    ...
    show_label: true,
    show_unit: true,
    gauge_settings: { start_angle: 0, end_angle: 270, color_primary: '#3b82f6', stroke_width: 8 },
  ...
  },
  {
    ...
    show_label: true,
    show_unit: true,
    gauge_settings: { time_range: 60, line_color: '#8b5cf6', fill_area: true, show_points: false },
    style_settings: noStyle
  },
  {
    ...
    show_label: true,
    show_unit: true,
    gauge_settings: { start_angle: 45, end_angle: 315, color_primary: '#f59e0b', stroke_width: 6 },
    style_settings: noStyle
  },
  {
...
/** Simulate live sensor data updates (used in demo mode) */
